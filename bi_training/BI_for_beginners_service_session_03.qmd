...
1.  Open Excel and create a blank workbook</br>![create a blank workbook](images/clipboard-3287158368.png){height="200"}
2.  In the `Data` tab of the ribbon menu, select the `From Web` option </br> ![select the `From Web` option](images/clipboard-563180817.png){height="100"}
3.  Supply the first URL </br>![Supply the first URL](images/clipboard-1386370273.png){height="100"}
4.  Select `Load` </br>![](images/clipboard-1784687147.png){height="200"}
...
-   You should be able to see each of your datasets in Excel as separate worksheets (with pretty horrible names) ![new worksheets in Excel](images/clipboard-1507354050.png)

## PowerQuery

Next, we'll open these three sets of data in PowerQuery by selecting `Launch Power Query Editor...` from the `Get Data` menu:</br> ![Launch Power Query Editor...](images/clipboard-468826289.png){height="300"}

## Navigating PowerQuery

![PowerQuery interface](images/clipboard-3570519607.png)
...
-   To make life easier, we'll rename each query by right-clicking the query title on the left-hand side of the screen </br>![rename each query](images/clipboard-4147252052.png):
...
-   we can safely lose several columns:
    ...
    -   right click the column header to `Remove` </br>![remove columns](images/clipboard-1367785018.png)

## The big idea

-   once you've removed a column, you'll see a change to the `Applied Steps` area: </br> ![Applied steps are](images/clipboard-1786703847.png)
...
-   Once you've removed the unnecessary columns, click `Close & Load` to commit your changes </br>![Commit your changes](images/clipboard-3018844657.png)
...
::: {.callout-tip title="Task"}
1.  select the HB column and select **Merge Queries** </br> ![select Merge Queries](images/merge.png)
1.  fill in the options in the merge pop-up </br> ![merge pop-up](images/merge2.png){height="300px"}
2.  note that this gives us lots of information about how the join is likely to work
:::

-   a slight puzzle: the join initially looks pretty unpromising </br>![nested columns](images/merge3.png)
...
::: {.callout-tip title="Task"}
1.  select the column(s) you want to keep from the column header </br> ![Select your columns from the expand button](images/merge4.png){height="150px"}
:::
...
2.  note that you can also do this inside the formula bar at the top of the screen </br> ![Formula bar](images/merge5.png)</br> This formula is written in **Power Query M**, which we'll discuss later
...
-   That should give us our data in long form, so that it looks like this: </br> ![long form data](images/pivot_2.png)
...
::: {.callout-tip title="Task"}
1.  Split the **Attribute** column by **Digit to Non-digit**</br>![Digit to non-digit](images/pivot_4.png){height="150px"}
...
-   there are a few duplicate practice names, which might cause us problems </br>![Duplicate practice names](images/barclay.png)

::: {.callout-tip title="Task"}
1.  select **Transform data**
2.  add a **Custom column** called Practice Name</br> ![Add a custom column](images/cust_col.png){height="200px"}
...
2.  In the **practices** table, note that you can change the summary options for the **PracticeListSize** column </br>![Summary defaults](images/summ_list.png){height="200px"}
:::
