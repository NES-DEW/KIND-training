...
![Final service use data report page](images/we_dash.png)
...
3.  Expand it to fill the bottom three-quarters of the visualisation area</br>![Expand the chart](images/line_chart.png)
:::
...
2.  Drag the three site columns to the Y-axis field</br>![Add site columns to Y-axis](images/wend_dat.png)
:::

## Add a slicer

::: {.callout-tip title="Task"}
1.  Click off your line graph, then add a slicer</br>![Add a slicer](images/we_slicer.png)
...
3.  Select the **Format your visual** menu</br>![Format your visual](images/we_format.png){height="100"}
4.  Format the slicer to use a dropdown</br>![Format the slicer](images/we_drop.png){height="200"}
:::

## Add some cards

::: {.callout-tip title="Task"}
1.  Add a card</br>![Add a card](images/we_card.png){height="200"}
...
::: {.callout-tip title="Task"}
1.  Go round using **Rename for this visual** to tidy up the names</br>![Rename for this visual](images/we_rename.png){height="200"}
...
![Final GP practice size report page](images/gp_final.png)

## Add a map

::: {.callout-tip title="Task"}
1.  Add a new page to your report
2.  Add a map and expand to fill the left-hand half of the visualisation area</br>![Add a new map](images/gp_map.png){height="200"}
...
::: {.callout-tip title="Task"}
1.  From the **Format visual** menu, change the map style to greyscale</br>![Map formatting](images/gp_format.png){height="200"}
...
::: {.callout-tip title="Task"}
1.  Can you find a way of colouring the bubbles by health board? </br> ![Use the legend field to colour bubbles by health board](images/gp_bub_col.png){height="350"}
:::
...
3.  Add a suitable title and format to suit </br> ![Population summary card](images/pract_dee.png){height="200"}
:::
...
2.  Add the `Name` on the X-axis, the `ListSize` on the Y-axis, and the `HBName` in the legend </br> ![Practice size chart](images/clipboard-804131740.png)
:::
...
2.  Add the `SIMD2020v2_quantile` on the X-axis, and the `Name` on the Y-axis. Make sure the `Name` field is set to count </br> ![Practice deprivation chart](images/clipboard-3163838897.png)
...
![Final report page](images/gp_final.png)
