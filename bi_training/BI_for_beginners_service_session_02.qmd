...
3. Expand it to fill the bottom three-quarters of the visualisation area</br>![](images/line_chart.png)
:::
...
2. Drag the three site columns to the Y-axis field</br>![](images/wend_dat.png)
:::
...
::: {.callout-tip title="Task"}
1. Click off your line graph, then add a slicer</br>![](images/we_slicer.png)
...
3. Select the **Format your visual** menu</br>![](images/we_format.png){height="100"}

4. Format the slicer to use a dropdown</br>![](images/we_drop.png){height="200"}
:::

## Add some cards

::: {.callout-tip title="Task"}
1. Add a card</br>![](images/we_card.png){height="200"}
...
## Tidy up the names
::: {.callout-tip title="Task"}
1. Go round using **Rename for this visual** to tidy up the names</br>![](images/we_rename.png){height="200"}
...
2. Add a map and expand to fill the left-hand half of the visualisation area</br>![](images/gp_map.png){height="200"}
...
## Format the map
::: {.callout-tip title="Task"}
1. From the **Format visual** menu, change the map style to greyscale</br>![](images/gp_format.png){height="200"}
...
::: {.callout-tip title="Task"}
1. Can you find a way of colouring the bubbles by health board? </br> ![](images/gp_bub_col.png){height="350"}
:::
...
5. Format to suit </br> ![](images/pract_dee.png){height="200"}
:::
