...
2.  Select `New Report`</br>![](images/clipboard-3571025835.png){height="150"}
:::

## Loading data

::: {.callout-tip title="Task"}
1.  select `Excel (preview)` </br>![select Excel (preview)](images/clipboard-4053349010.png){height="150"}
2.  select `Upload file` </br>![](images/clipboard-916950338.png)
3.  now drag your Excel workbook into the Power BI window</br>![drag your Excel workbook into the Power BI window](images/clipboard-357030995.png)
:::
...
2.  select the two tables in the preview and select `Create` </br> ![select the two tables in the preview and select Create](images/clipboard-815799949.png)
:::

## The Report View

![Report view](images/clipboard-3761155047.png)
...
-   you should also save your report at this point</br>![Save your report](images/clipboard-435366504.png)
...
::: {.callout-tip title="Task"}
1.  make sure you select `Edit` from the menu </br> ![select Edit](images/clipboard-1317552922.png)
2.  Select `Line chart` from the visualizations pane </br> ![Select Line chart from the visualizations pane](images/clipboard-812342158.png){height="300"}
...
4.  Add some data:
    ...
    b.  Drag the `date` column from the occupancy table to the **X-axis field** </br>![date in x axis, occupiedbeds in the y axis](images/clipboard-2429031845.png)
:::

+ you should have a nice, craggy, time series graph of bed occupancy </br> ![Bed occupancy time series](images/aggchart.png)
+ don't panic if you have a straight-line graph</br>![Straight line graph](images/clipboard-1010441889.png)
...
+ you control aggregation from the drop-down menu on the data in your field</br> ![drop-down menu on the date data](images/clipboard-1180337001.png)
-   we can do similar aggregations on our other data too. Swap `Sum` for `Average` in your `OccupiedBeds` field ![drop-down menu on the occupied beds data](images/clipboard-909269035.png)

## Making our chart more useful

::: {.callout-tip title="Task"}
1.  Try dragging the **WardName** column to the **Legend** field </br> ![](images/legend.png){height="400"}
:::

or to the `Small multiples` field:

![](images/clipboard-2313058786.png)

## Formatting

![](images/clipboard-3526313208.png)
...
-   this is easy: just make sure your chart is selected (look for the tiny grey corners ![graph corners](images/clipboard-58530006.png)), and click a new graph icon (liked stacked columns ![new graph icon](images/clipboard-1162591482.png))
-   that will change the type of graph you're building - in this case, to a stacked column chart </br>![stacked column chart](images/clipboard-3312791348.png)

## What's happening behind the scenes?

-   to to your workspace ![](images/clipboard-3750165785.png)

-   you should see a graph for your dashboard ![](images/clipboard-1712134014.png)

-   now follow the `...` menu from the `Semantic model` to `Open data model` ![Open data model](images/clipboard-3886944991.png)

## The data model

-   the data model gives you an overview of your data ![Data model](images/clipboard-4151043456.png)
...
::: {.callout-tip title="Task"}
1.  select **New column** from the ribbon </br> ![select New column from the ribbon](images/clipboard-171542657.png)
1.  now we write a formula in the formula bar: `AvailableBeds = [BedComp] - [ClosedBed]` </br> ![add a formula to the formula bar](images/formula.png){height="100"}
