...
<iframe src="https://player.vimeo.com/video/1089091364?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="KIND network - BI for Beginners session 1">
...
## Do I have Power BI desktop?

You need **both** a licence and the installed software to run Power BI desktop.

-   to check that you have a Power BI desktop licence, go to [your Microsoft subscription page](https://portal.office.com/account/#subscriptions). Make sure you're signed-in, and then search in the page for `Power BI Pro`. If that appears in your list of subscriptions then you have a Power BI desktop licence.
-   then, in your Windows Start menu, look for an installed app called `Power BI Desktop`: ![Power BI Desktop](images/clipboard-2948912569.png)

If one or both of these are lacking, you'll probably need to contact your IT support team
:::
