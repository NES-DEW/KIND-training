...
::: {.callout-tip title="Task"}
1. Open Power BI desktop </br> ![](images/openbi.png){height="450"}
:::
...
2. go to the **Get data** dropdown on the ribbon, and select **Excel workbook** </br>  ![](images/getdat.png){height="200"}
:::
...
2. select the two tables in the preview and select **load** </br> ![](images/datfield.png){height="400"}
:::
...
::: columns
::: {.column width="40%"}
![](images/3view.png){width="300" fig-align="center"}
:::
...
- we'll talk about these relationships more in session 4 </br> ![](images/startmodel.png)
...
4.  Look through the ribbon's **Column tools** to see what options are available </br> ![](images/summ.png){height="250px"}
:::
...
2.  Select **Line chart** from the visualizations pane </br> ![](images/line.png){height="300"}
3.  Enlarge the visualisation to fill the page
4.  Add some data:
    a. Drag the **OccupiedBeds** column from the occupancy table to the **Y-axis** field
    b. Drag the **Date** column from the occupancy table to the **X-axis field** </br> ![](images/xy.png)
:::
...
4.  refresh the data </br> ![](images/fresh.png){height="200"}
:::
...
2.  select **New column** from the ribbon </br> ![](images/newcol.png){height="200"}
3.  now we write a formula in the formula bar: `AvailableBeds = [BedComp] - [ClosedBed]` </br> ![](images/formula.png)
