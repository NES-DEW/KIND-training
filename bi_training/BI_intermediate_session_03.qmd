...
+ we'll use the [NRS vital events data for Q3 2024](https://www.nrscotland.gov.uk/media/arkfqyyr/q3-2024-data.xlsx) as our main source
...
+ we'll also do a demo about data structures in Excel. You're [welcome to download that too](src/Inter_bi_s03.xlsx) and open it in Excel
