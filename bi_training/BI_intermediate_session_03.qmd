...
-   session 1: [a simple build-a-dashboard session as a warmup, reminder about core Power BI techniques, and sharing some suggestions for good workflow practices](intermediate_BI_session_01.qmd)
...
-   `New query > Web`</br>![Load data from web](images/clipboard-3224181959.png)
-   supply the link for the NRS vital events data for Q3 2024: <https://www.nrscotland.gov.uk/media/arkfqyyr/q3-2024-data.xlsx>

## Tables and sheets

-   we want table 6 </br>(`TableQ6_Deaths_by_sex_cause_and_NHS_Board_area`) ![Table 6](images/clipboard-849064723.png)
-   please import that from the navigator

## Tidying up

-   remove the three `All` rows </br>![Filter out the three all rows](images/clipboard-623679649.png)
-   check the data types
-   fix the query name to `cause_death` </br>![Rename to cause_death](images/clipboard-1287398295.png)

## This data isn't quite tidy

![Tidy data](images/clipboard-3584154739.png)
...
-   you might also see Power BI data described as a star schema </br>![Star schema](images/clipboard-2583516447.png) image: [Wikimedia](https://commons.wikimedia.org/wiki/File:%D0%9F%D1%80%D0%B8%D0%BA%D0%BB%D0%B0%D0%B4_%D1%81%D1%85%D0%B5%D0%BC%D0%B8_%D0%B7%D1%96%D1%80%D0%BA%D0%B8.png)
...
-   then unpivot everything but `ICD10` and `Sex`</br> ![Unpivot](images/clipboard-279191218.png)
...
-   right-click the `Table`, and select `Add as New Query`</br>![Add as New Query](images/clipboard-4014078747.png)
-   rename that new query `population`

## Make a population table

-   remove everything but the first three columns </br> ![First three columns](images/clipboard-3972508190.png)
