...
3. Select the two tables (`gp_size` and `weekend_service`) and have a look at the preview</br>![Select both tables](images/s02data.png)
4. Load those tables
:::

## Visualising service use
![Service use dashboard](images/we_dash.png)
...
3. Expand it to fill the bottom three-quarters of the visualisation area</br>![Expand the line chart to fit](images/line_chart.png)
:::
...
2. Drag the three site columns to the Y-axis field</br>![Add three site columns to the y-axis field](images/wend_dat.png)
:::
...
::: {.callout-tip title="Task"}
1. Click off your line graph, then add a slicer</br>![Slicer](images/we_slicer.png)
...
5. Select the **Format your visual** menu</br>![Format your visual](images/we_format.png){height="100"}
6. Format the slicer to use a dropdown</br>![Dropdown slicer](images/we_drop.png){height="200"}
:::

## Add some cards

::: {.callout-tip title="Task"}
1. Add a card</br>![Card](images/we_card.png){height="200"}
...
## End result
![Final dashboard](images/we_dash.png)

##  GP practice size

![GP practices map dashboard](images/gp_final.png)

## Add a map
::: {.callout-tip title="Task"}
1. Add a new page to your report
2. Add a map and expand to fill the left-hand half of the visualisation area</br>![Add a map](images/gp_map.png){height="200"}
...
## Format the map
::: {.callout-tip title="Task"}
1. From the **Format visual** menu, change the map style to greyscale</br>![Greyscale map](images/gp_format.png){height="200"}
...
::: {.callout-tip title="Task"}
1. Can you find a way of colouring the bubbles by health board? </br> ![Colour bubbles by health board](images/gp_bub_col.png){height="350"}
:::
...
5. Format to suit </br> ![Format the title](images/pract_dee.png){height="200"}
:::
...
![Final dashboard](images/gp_final.png)
