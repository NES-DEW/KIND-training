...
-   repeat the `total_responses` summary work from the previous example as per the screenshot below: ![Levels of grouping](images/clipboard-3920954063.png)
-   that should yield a similar sum of responses, but this time the groups will be per-area and per-question ![Mult-layer grouping](../src/images/pq_total_responses_multi.png)
...
![Multiple aggregations](../src/images/pq_total_responses_multi_agg.png) That should yield multiple summary columns with values for each group:
...
Please can you [spare us one minute of your time to give feedback](%60r%20KINDR::feedback_url(params$fn,%20date%20=%20params$sl_date)%60)?
:::
