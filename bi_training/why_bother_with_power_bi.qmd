...
![]../src/images/clipboard-1773606480.png) 

### preview the data </br>
![]../src/images/clipboard-3750020719.png)

### work with the data in Power BI </br> 
![]../src/images/clipboard-887422480.png)

### tidy/wrangle the data in Power Query </br> 
![]../src/images/clipboard-2135432491.png)
### add a map visual </br> 
![]../src/images/clipboard-4289264945.png)

### populate with our data </br> 
![]../src/images/clipboard-4285049290.png)

### add a column graph </br> 
![]../src/images/clipboard-4221248636.png)

### populate with drag and drop </br> 
![]../src/images/clipboard-1883827365.png)

### add slicer </br> 
![]../src/images/clipboard-1767130583.png) 

### slicers change our visualisations </br> 
![]../src/images/clipboard-2628441850.png)

### add a numeric summary </br> 
![]../src/images/clipboard-3093070697.png)
