...
params:
  sl_date: 2025-09-10
  fn: "Intermediate Power BI (session 2)"
  id: KP25
---
...
-   session 2 (this session): [DAX language foundations, including FILTER and CALCULATE](BI_intermediate_session_02.qmd)
...
-   session 5: [a second, more ambitious, build-a-dashboard session to put all that PowerQuery and DAX knowledge into practice](BI_intermediate_session_05.qmd)
...
- look in more detail at date tables as a warmup
...
-   please [use this link](https://nes-dew.github.io/KIND-training/bi_training/src/traffic_detail.xlsx) to import into Power BI. You should be able to do that directly from the Excel connector.
...
- if you try the same formula in `temp_measure` you'll cause an error: Power BI won't know which row you want to change the case of  \n ![Different filter context for the measure](../src/images/BI_inter_single_val.png)
- this indicates a different **filter context** at play in this DAX formula when used as either a column or as a measure
