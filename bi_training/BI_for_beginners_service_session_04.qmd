...
::: {.callout-tip title="Task"}
1.  Click `Open data model`</br> ![Open the data model]../src/images/clipboard-1311221330.png)
2.  That should open the data model in a new tab </br>   ![data model tab]../src/images/clipboard-1681953392.png)
