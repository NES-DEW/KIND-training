...
params:
  sl_date: 2025-11-04
  fn: Excel foundations 2 (intermediate Excel session 2)
  id: KE12
format: html
date: '`r params[["sl_date"]]`'
title: Excel foundations 2 (intermediate Excel session 2)
---
...
+ download this workbook: [https://nes-dew.github.io/KIND-training/excel/src/KIND_excel_skills_s02_exercises.xlsx](https://nes-dew.github.io/KIND-training/excel/src/KIND_excel_skills_s02_exercises.xlsx)
...
Please download and open the training file: [s02_exercises.xlsx`](src/KIND_excel_skills_s02_exercises.xlsx). Depending on your version of Excel, you may need to enable editing.
...
1. find the `service_use` worksheet
...
::: {.callout-tip title="Task"}
1. Try pressing `Ctrl` + ` (backtick). What do you see? </br>![Formula auditing](../src/images/02_backtik.png){height="100px"}
:::
