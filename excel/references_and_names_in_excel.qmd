...
![](images/clipboard-4090026779.png)
...
-   in cell `E2`, add the following formula: `= TODAY() - C2`
    ...
    -   you may need to correct the formatting </br> ![](images/clipboard-2200716982.png){height="200"}
-   then copy/fill down
:::
...
-   find the **Name manager** (or press `Ctrl` + `F3`) </br> ![](images/clipboard-3382288451.png)
