...
+ given that match gives us the row number, and index takes a row number and returns a value, we can link them up nicely </br>![Index and match logic](images/03_indemat.png)
