...
* the course has four main sessions and a fifth, optional, session designed for colleagues planning to use R and SQL together. The sessions are designed to be taken in order (and ideally together in a block)
    * session one - [An introduction to SQL](sql_intro.html)
    * session two - [Getting data into SQL](sql_data.html)
    * session three - [Filtering and aggregating data with SQL](sql_filter_aggregate.html)
    * session four - [SQL joins](sql_joins.html)
    * an optional fifth session, for colleagues interested in using SQL with R - [R and SQL](sql_r.html)
:::
