...
-   you may need to play with the `Fit` menu to see your results:</br> ![The Fit menu](images/clipboard-2278766619.png)

::: {.callout-tip title="Task"}
-   try `"The first practice name is " + MIN([GP Practice Name])`
:::
