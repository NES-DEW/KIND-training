...
## Session materials
-  dataset for this session [{{< iconify ph:file-xls size=2x >}}.xlsx](data/s02_data.xlsx)
...
2.  from the `s02_data.xlsx` file, add `gp_size_sh` to your data and start a new worksheet
