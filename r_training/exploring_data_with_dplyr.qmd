...
Although we've got code linking on these pages, so that you can click function names and see the documentation, it's definitely worth pointing you towards the [slice() manual page](https://dplyr.tidyverse.org/reference/slice.html) - it's clear and interesting.
