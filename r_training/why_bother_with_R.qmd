...
readr::read_csv("r_training/data/spc/spc2.csv") |>
    mutate(date = lubridate::dmy(date)) |>
    NHSRplotthedots::ptd_spc(members, date, target=50, fix_after_n_points=20) 

```

![SPC chart using the NHSRplotthedots package](../src/images/spc.png)
