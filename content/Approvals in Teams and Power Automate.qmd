...
-   Teams approval should appear ![Teams approval](../src/images/clipboard-1858339355.png)
-   and an email... ![Email approval](..src/images/clipboard-3242366602.png)
-   in Teams, add a comment, and click `Approve`

## Several things happen

-   Teams approvals keeps a neat log of events for you ![Teams approval log](../src/images/clipboard-1263615662.png)
...
-   build yourself an email with the approval comment and the date-time ![Example email setup](../src/images/clipboard-3887599392.png)
-   then re-test your approval

## Control flow

-   you can add a condition - just note that you need to use the work `Succeeded` in the condition </br>![Control flow on approvals](../src/images/clipboard-3044742246.png)
