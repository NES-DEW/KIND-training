...
* we'll then do a more technical practical using Git in [posit.cloud](https://posit.cloud) as a convenient way of setting up an easy-to-understand git setup without having to install/configure software

:::{.callout-note collapse=true appearance='default' icon=true}
## Questions for you

1. Have you ever used Git before?
1. Do you currently use git?
1. If so, what for / how has it helped you? 
1. What scares you most about using git?
:::
