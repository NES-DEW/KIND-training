...
![Truth survival in original articles on hepatitis and cirrhosis [@poynard2002]](images/01_half_life.png){height="400"}
...
![[@sackett1979]](images/01_bias.png)
...
![Exposure causes outcome](images/01_conf1.png)
:::

::: {.column width="50%"}
**What's actually happening** ![Confounding factor is associated with both exposure and outcome](images/01_conf2.png)
:::
:::
...
::: {.callout-tip title="Task"}
-   take a look at this plot of coronary artery disease rates: </br>![CHD rates](images/01_conf_example.png)
...
::: columns
::: {.column width="40%"}
![Coffee correlation](images/clipboard-1310662237.png)
:::
...
![Blobbogram polling](images/clipboard-1388595878.png)
...
-   because EBM introduced methods for appraising evidence, this gave rise to a ranking of kinds of evidence</br>![EBM pyramid](images/01_pyramid.png)
