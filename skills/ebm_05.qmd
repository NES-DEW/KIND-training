...
params:
  sl_date: 2026-05-27
  fn: An introduction to EBM (session 5)
  id: KS28
...
## E1: the Cochrane logo

::: {.callout-tip title="Task"}
1.  Please visit <https://www.cochrane.org/>
2.  Two questions for the chat:
    1.  What does Cochrane do?
    2.  What does their logo show?
:::
...
knitr::include_graphics("https://www.cochrane.org/themes/custom/cochrane_hs/img/logo.png")
...
::::: columns
::: {.column width="30%"}
![Ben Goldacre's Bad Pharma](images/clipboard-3419611808.png)
:::
...
![Internal vs external validity](../src/images/05_exval.png){height="250"}
