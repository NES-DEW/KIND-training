...
params:
  sl_date: 2025-12-05
  fn: An introduction to EBM (session 3)
  id: KS26
date: 2025-12-05
...
We'll mainly discuss appraisal today, with a side-order of formulate and retrieve, and we'll neglect application and evaluation almost entirely.

## Formulate

![Formulate a research question](../src/images/03_form.png)
...
![@Greenhalgh2019](../src/images/03_levels.png)
...
::: {.column width='50%'}
![Broad fields of research](../src/images/03_overview.png){height=400px}
:::
