...
glossary::glossary_path(here::here("glossary.yml"))
```
...
This session aims to help you understand what data is, how data helps us do good work in health and care, and what we need to know about data to achieve that. Here, we'll explore the idea that data is an especially powerful way of understanding how systems in health and care. That's because data is an excellent way of answering some of the most important questions about our work, such as:
...
Practicing new skills is essential to make them stick. This course sets up little bits of homework: short and flexible tasks to allow you to put what you've learned in a session into practice.
