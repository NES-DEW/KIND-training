...
Early engagement by an audience is really helpful!

An example: using an icebreaker
...
Especially if you're nervous, hearing contributions from the audience is extremely helpful.

We use this image in the session. We poll participants saying "which do you most identify with", and then follow-up by inviting free-text comments in the chat, and for participants to come and chat through their thoughts:
...
Five minutes, one topic:
+ one poll activity
+ one chat activity (1-2-3, chat, send - draft an answer, then everyone sends at the same time)
