...
:::{.callout-tip collapse=false appearance='default' icon=true}
### Warm-up task
- Imagine that you had to present a recap of the past two sessions of this course
- In the main meeting chat, please make some suggestions:
  - What would you want to say?
  - How would you like to do it?
  - What polls/activities/resources might you like to include?
...
- Chance for feedback and discussion in the chat
:::

::: {.callout-note collapse="false" appearance="default" icon="true"}
### 30-seconds practice

- jot down your work bio ("I'm x, I work in y, where I do z")
- we'll try and deliver that in exactly 30 seconds
  - 1 x silent practice
  - 1 x out loud practice with your mic off
  - 1 x out loud out with your mic on
- followed by reflection and follow-up
- then we'll break out to small groups for feedback
